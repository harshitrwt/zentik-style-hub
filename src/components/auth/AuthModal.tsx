  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (mode === "signup" && data?.error === "Email already in use") {
          setEmailError("User with this email already exists");
          return;
        }

        // LOGIN: generic error (email OR password wrong)
        if (mode === "login") {
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-secondary rounded-lg ${emailError ? "border border-red-500" : "border border-border"
                  }`}
                required
              />
              {emailError && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 bg-secondary rounded-lg ${passwordError ? "" : "border border-border"
                    }`}
                  required
                />
                <button
